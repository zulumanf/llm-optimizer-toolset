...
describe("active cohort + follow-up eligibility (spec 100)", () => {
  ...
  it("followUpDueAt lands on the business-day cadence and agrees with isFollowUpDue", async () => {
    ...
    const facts = { prospectId: "p", businessName: "x", launchId: "l", launchName: "L", qualityScore: 50, stage: "contacted" as const, visitedStages: [], sentAts: [sentThu], sends: [], prospectType: null, repliedAt: null, meetingAt: null, opens: 0, views: [], hasEmail: true, auditPublished: true };
